...
def create_parser():
    ...
    parser.add_argument('--test_data', type=str, default='./data/dgcnn/data_test.npy')
    parser.add_argument('--test_label', type=str, default='./data/dgcnn/label_test.npy')
    parser.add_argument('--output_dir', type=str, default='./output')
    parser.add_argument('--task', type=str, default="dgcnn", help='The task: dgcnn')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        model_path = './checkpoints/dgcnn/{}.pt'.format(args.load_checkpoint)
